...
if __name__ == '__main__':
    print prime_numbers(5) # running time 4.48226928711e-05
    print prime_numbers(10) # running time 1.50203704834e-05
    print prime_numbers(100) # running time 0.000203132629395
    print prime_numbers(500) # running time 0.00300407409668
